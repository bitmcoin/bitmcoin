...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bitmcoin Core bitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitmcoin transaction") + "\n" +
              "  bitmcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitmcoin transaction") + "\n" +
              "\n";

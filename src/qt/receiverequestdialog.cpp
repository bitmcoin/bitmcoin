// Copyright (c) 2011-2013 The Bitmcoin Core developers
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitmcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitmcoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitmcoinURI(info));
}

...
/** Bitmcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitmcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitmcoinUnits(QObject *parent);
...
typedef BitmcoinUnits::Unit BitmcoinUnit;

// Copyright (c) 2009-2014 The Bitmcoin Core developers
...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseBitmcoinURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseBitmcoinURI("bitcoin://175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());

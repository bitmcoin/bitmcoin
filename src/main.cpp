...
#if defined(NDEBUG)
# error "Bitmcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitmcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s BTM additional fees, %d delta bytes\n",
